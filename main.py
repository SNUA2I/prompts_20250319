...
Sentiment:"""
    },
    {
        ...
        "prompt": """고객의 피자 주문을 유효한 JSON으로 변환한다.
...
JSON 응답:"""
    },
    {
        ...
        "prompt": """당신은 프로그래밍 튜터입니다. 사용자가 배우고 싶은 프로그래밍 언어나 해결하고 싶은 문제를 알려주면, 단계별로 설명해주세요.
...
"""
    },
    {
        "group": "프롬프트 기법",
        "title": "답변 길이 지정",
        "prompt": """학생 회장 선거 연설문을 트윗 길이로 작성하세요.
...
"""
    },
    {
        ...
        "prompt": """최근 5년 내에 출판된 인공지능 분야의 비소설 책 중에서 평점이 4.5 이상인 책을 5권 추천해주세요.
--------------------------------------
제목: <책 제목>
저자: <책 저자>
내용: <책 내용 요약>
...
"""
    },
    {
        "group": "프롬프트 기법",
        "title": "템플릿 사용",
        "prompt": """출력물을 위한 템플릿을 제공해 드리겠습니다. 꺾쇠 괄호 <> 안의 단어가 플레이스홀더입니다. 플레이스홀더를 채워주세요. 제 템플릿의 전체 서식을 그대로 유지해 주세요. 제 템플릿은 다음과 같습니다:
...
"""
    },
    {
        "group": "프롬프트 기법",
        "title": "더 나은 질문 만들기",
        "prompt": """지금부터 내가 질문을 할 때, 더 나은 질문 방식이 있다면 제안하고, 그 질문을 사용할지 여부를 나에게 물어봐 주세요.
...
"""
    },
    {
        "group": "프롬프트 기법",
        "title": "대안 프롬프트 요청하기",
        "prompt": """내가 작업을 수행하기 위한 프롬프트를 작성해 달라고 요청할 때마다 작업이 무엇인지 나열하고, 작업을 완료하기 위한 대체 접근 방법을 나열한 다음, 각 접근 방식에 대한 프롬프트를 직접 작성하세요. 완료되면 대안을 작성할 다음 프롬프트를 만들 수 있는지 물어보세요.
...
"""
    },
    {
        "group": "프롬프트 기법",
        "title": "질문 받기",
        "prompt": """나는 수학 공부를 잘 하고 싶어요. 이 목표를 달성하기 위해 나에게 질문을 해 주세요. 충분한 정보를 얻어 나에게 적합한 수학 공부 계획을 제안할 수 있을 때까지 질문을 계속하세요. 정보를 다 모으면 수학 공부 계획을 보여 주세요. 질문을 한 번에 하나씩 하세요. 
...
"""
    },
    {
        ...
        "prompt": """충분한 정보를 얻어 나에게 적합한 근력 운동 계획을 제안할 수 있을 때까지 질문을 계속하세요. 정보를 다 모으면 근력 운동 계획을 보여 주세요. 질문을 한 번에 하나씩 하세요. 
...
"""
    },
    {
        "group": "프롬프트 기법",
        "title": "수학 게임",
        "prompt": """수학 게임을 하겠습니다. 분수와 관련된 질문을 하고 맞출 때마다 점수를 증가시키세요. 답이 틀리면 이유를 알기 쉽게 설명하세요.
"""
    },
    {
        "group": "프롬프트 기법",
        "title": "AI를 프로그래밍 할 수 있을까?",
        "prompt": """아래 내용을 CSV 형식으로 출력하세요.
...
"""
    },
    {
        "group": "프롬프트 기법",
        "title": "여행 계획",
        "prompt": """여행 계획 애플리케이션을 만들려고 합니다. 저는 제 여행에 관해 설명하고 당신은 제가 지나갈 장소에서 할 수 있는 흥미로운 일을 나열합니다. 각 장소에서 며칠 동안 머무를 것인지 알려드리고 가능한 여정을 나열하겠습니다.
...
"""
    },
    {
        "group": "프롬프트 기법",
        "title": "경유지 목록 생성",
        "prompt": """기능을 추가하려고 합니다. 출발지와 도착지를 알려주면 출발지와 도착지 사이에 경유할 장소를 포함한 전체 경유지 목록을 제공합니다.
...
"""
    },
    {
        "group": "프롬프트 기법",
        "title": "개요 확장하기",
        "prompt": """개요 확장자 역할을 하세요. 제가 입력한 내용을 바탕으로 글머리 번호 개요를 생성한 다음, 어떤 글머리 번호를 확장할지 물어봅니다. 제가 선택한 글머리 번호에 대한 새로운 개요를 만듭니다. 마지막에는 다음에 확장할 글머리 기호를 물어보세요.
...
"""
    },
    {
        "group": "프롬프트 기법",
        "title": "액션 메뉴 만들기",
        "prompt": """내가 입력한 내용을 바탕으로 글머리 번호 개요를 생성한 다음, 어떤 글머리 번호를 확장할지 물어봅니다. 내가 선택한 글머리 번호에 대한 새로운 개요를 만듭니다. 내가 "<글머리 번호> 글쓰기"라고 입력하면, 선택한 글머리 번호 <글머리 번호>에 대한 내용을 작성합니다. 최소한 3단락 이상의 내용을 작성합니다. 내가 "<글머리 번호>"만 입력하면, 해당 글머리 기호를 확장합니다. 마지막에는 다음 작업을 물어보세요.
...
"""
    },
    {
        "group": "프롬프트 기법",
        "title": "역 프롬프트",
        "prompt": """https://singjupost.com/steve-jobs-how-to-live-before-you-die-2005-speech-full-transcript/
...
"""
    },
    {
        "group": "프롬프트 기법",
        "title": "대안 접근 방식 요청하기",
        "prompt": """지금부터 같은 작업을 수행할 수 있는 다른 방법이 있다면 가장 좋은 대안을 나열하세요. 대안을 비교하고 대조한 다음 어떤 방법을 사용할지 물어보세요.
...
"""
    },
    {
        "group": "프롬프트 기법",
        "title": "시멘틱 필터링",
        "prompt": """다음 내용을 필터링하여 개인 식별이 가능한 정보 또는 개인을 재식별하는 데 사용될 수 있는 정보를 제거합니다. 정보를 제거한 후 최소한의 수정으로 내용을 자연스럽게 만듭니다.
...
"""
    },
    {
        ...
        "prompt": """주어진 질문에 답하십시오. 당신은 검색에 접근할 수 있습니다.
...
"""
    },
    {
        "group": "이미지 프롬프트",
        "title": "이미지 인식 (2)",
        "prompt": """이 개 품종은 무엇인가요? 한 단락에 글머리 기호로 설명하세요.
"""
    },
    {
        "group": "이미지 프롬프트",
...
"""
    },
    {
        ...
        "prompt": """이게 무슨 문제인가요? 좋은 숫자는 무엇이어야 하나요?
"""
    },
    {
        "group": "이미지 프롬프트",
...
"""
    },
    {
        "group": "이미지 프롬프트",
        "title": "영양 분석",
        "prompt": """다이어트 중이에요. 어떤 음료를 마셔야 할까요?
...
"""
    ...
    },
    {
        "group": "이미지 프롬프트",
        "title": "데이터 변환",
        "prompt": """차트를 Markdown 테이블로 변환합니다.
...
"""
    },
    {
        "group": "이미지 프롬프트",
        "title": "냉장고 음식으로 요리하기",
        "prompt": """냉장고에는 무엇이 있나요? 어떤 종류의 음식을 만들 수 있나요? 냉장고에 있는 재료만을 기준으로 두 가지 예를 보여주세요.
...
"""
    },
    {
        "group": "이미지 프롬프트",
        "title": "수학 문제 채점",
        "prompt": """학생의 수학 숙제에서 각 답을 주의 깊게 확인하고, 먼저 계산을 한 다음, 결과를 학생의 답과 비교하고, 각 답에 정답 또는 오답을 표시한 다음, 마지막으로 모든 문제에 대한 총점을 반환하세요.
"""
    },
...
if not st.session_state["global_unlock"]:
    with st.form("unlock_form"):
        ...
        if submitted:
            if global_pwd == "global1234":  # 원하는 비밀번호
